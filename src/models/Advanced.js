        ...
        <div>
                ...
                <div className="container items-center max-w-7xl px-8 mx-auto xl:px-5">
                    <div className="flex flex-wrap items-stretch sm:-mx-3">
                        <div className="w-full md:w-1/2 md:px-5">
                            <Link to="/advanced/additional_switch_modifications" className="w-full h-auto overflow-hidden rounded-md shadow-xl sm:rounded-xl">
                        ...
                        <div className="w-full md:w-1/2 md:px-3 flex items-center pt-10 md:pt-0">
                            <div className="w-full pb-6 space-y-6 md:max-w-md lg:max-w-xl md:space-y-4 lg:space-y-8 xl:space-y-9 sm:pl-5 md:pb-0">
                                ...
                                <Link to="/advanced/additional_switch_modifications" className="text-center text-first text-xl"><u>Read more ➜</u></Link>
            ...
            <section className="px-2 py-12 bg-white md:px-0">
                <div className="container items-center max-w-7xl px-8 mx-auto xl:px-5">
                    <div className="flex flex-wrap items-stretch sm:-mx-3">
                        <div className="w-full md:w-1/2 md:px-5">
                            <Link to="/advanced/keyboard_foam" className="w-full h-auto overflow-hidden rounded-md shadow-xl sm:rounded-xl">
                        ...
                        <div className="w-full md:w-1/2 md:px-3 flex items-center pt-10 md:pt-0">
                            <div className="w-full pb-6 space-y-6 md:max-w-md lg:max-w-xl md:space-y-4 lg:space-y-8 xl:space-y-9 sm:pl-5 md:pb-0">
                                ...
                                <Link to="/advanced/keyboard_foam" className="text-center text-first text-xl"><u>Read more ➜</u></Link>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="px-2 py-12 bg-white md:px-0">
                <div className="container items-center max-w-7xl px-8 mx-auto xl:px-5">
                    <div className="flex flex-wrap items-stretch sm:-mx-3">
                        <div className="w-full md:w-1/2 md:px-5">
                            <Link to="/advanced/diy_modifications" className="w-full h-auto overflow-hidden rounded-md shadow-xl sm:rounded-xl">
                        ...
                        <div className="w-full md:w-1/2 md:px-3 flex items-center pt-10 md:pt-0">
                            <div className="w-full pb-6 space-y-6 md:max-w-md lg:max-w-xl md:space-y-4 lg:space-y-8 xl:space-y-9 sm:pl-5 md:pb-0">
                                ...
                                <Link to="/advanced/diy_modifications" className="text-center text-first text-xl"><u>Read more ➜</u></Link>
                            </div>
                        </div>
                    </div>
                </div>
