    ...
    return (
        <div>
                        ...
                        <div className="flex flex-col items-start justify-center w-full h-full py-6 mb-6 md:mb-0 md:w-1/2">
                            <div className="flex flex-col items-start justify-center h-full space-y-3 transform md:pl-10 lg:pl-16 md:space-y-5">
                                ...
                                <ul className="pl-16 text-lg list-disc">
                                    <li><HashLink to="#keycaps" className="underline">What are Keycaps?</HashLink></li>
                                    <li><HashLink to="#keycapSizes" className="underline">Keycap Sizes</HashLink></li>
                                    <li><HashLink to="#profiles" className="underline">Keycap Profiles</HashLink></li>
                                    <li><HashLink to="#materials" className="underline">Keycap Materials</HashLink></li>
                                    <li><HashLink to="#methods" className="underline">Production Methods</HashLink></li>
                                    <li><HashLink to="#naming" className="underline">Keysets and Naming</HashLink></li>
                                </ul>
                ...
                <div className="container items-center text-center justify-center max-w-7xl px-8 mx-auto xl:px-5">
                                    ...
                                    <div className="flex flex-wrap items-stretch sm:-mx-3">
                                        <div className="w-full md:w-1/2 md:px-5">
                                            <div className="w-full h-auto overflow-hidden rounded-md shadow-xl sm:rounded-xl">
                                                <img src={primus} alt="GMK White-Blue" />
                                            </div>
                                            <div>
                            ...
                            <section className="px-2 py-12 bg-white md:px-0">
                                <div className="container items-center max-w-7xl px-8 mx-auto xl:px-5">
                                    <div className="flex flex-wrap items-stretch sm:-mx-3">
                                        <div className="w-full md:w-1/2 md:px-5">
                                            <div className="w-full h-auto overflow-hidden rounded-md shadow-xl sm:rounded-xl">
                                                <img src={galactic} alt="DSA Galactic Empire" />
                                            </div>
                                            <div>
                            ...
                            <div className="container max-w-6xl mx-auto">
                                <div className="grid grid-cols-3 gap-8 mt-10 sm:grid-cols-6 lg:grid-cols-9 sm:px-8 xl:px-0 text-center">
                                    <div className="relative flex flex-col items-center justify-start col-span-3 px-8 py-12 space-y-4 overflow-hidden sm:rounded-xl">
                                        <div href="/introduction/introduction_to_mechanical_keyboards" className="w-full h-44 relative overflow-hidden shadow-xl">
                                            <img src={redSamurai} alt="GMK Red Samurai" className="absolute -right-3 scale-125" />
                                        </div>
                                    ...
                                    <div className="flex flex-col items-center justify-start col-span-3 px-8 py-12 space-y-4 overflow-hidden sm:rounded-xl">
                                        <div className="w-full h-44 relative overflow-hidden shadow-xl">
                                            <img src={pomJelly} alt="POM Jelly" className="absolute bottom-0 scale-125" />
                                        </div>
                                    ...
                                    <div className="flex flex-col items-center justify-start col-span-3 px-8 py-12 space-y-4 overflow-hidden sm:rounded-xl">
                                        <div className="w-full h-44 relative overflow-hidden shadow-xl">
                                            <img src={deadBeats} alt="DCS Deadbeats" className="absolute bottom-0 scale-125" />
                                        </div>
                                    ...
                                    <div className="relative flex flex-col items-center justify-start col-span-3 px-8 py-12 space-y-4 overflow-hidden sm:rounded-xl">
                                        <div className="w-full h-44 relative overflow-hidden shadow-xl">
                                            <img src={vileBloom} alt="SA Vilebloom" className="absolute bottom-0 scale-110" />
                                        </div>
                                    ...
                                    <div className="flex flex-col items-center justify-start col-span-3 px-8 py-12 space-y-4 overflow-hidden sm:rounded-xl">
                                        <div className="w-full h-44 relative overflow-hidden shadow-xl">
                                            <img src={astrolokeys} alt="DSA Astrolokeys" className="absolute -bottom-4 scale-110" />
                                        </div>
                                    ...
                                    <div className="flex flex-col items-center justify-start col-span-3 px-8 py-12 space-y-4 overflow-hidden sm:rounded-xl">
                                        <div className="w-full h-44 relative overflow-hidden shadow-xl">
                                            <img src={milkshake} alt="KAT Milkshake" className="absolute -bottom-6 scale-110" />
                                        </div>
                                    ...
                                    <div className="flex flex-col items-center justify-start col-span-3 px-8 py-12 space-y-4 overflow-hidden sm:rounded-xl">
                                        <div className="w-full h-44 relative overflow-hidden shadow-xl">
                                            <img src={littlePilot} alt="KAM Little Pilot" className="absolute -bottom-2 scale-125" />
                                        </div>
                                    ...
                                    <div className="flex flex-col items-center justify-start col-span-3 px-8 py-12 space-y-4 overflow-hidden sm:rounded-xl">
                                        <div className="w-full h-44 relative overflow-hidden shadow-xl">
                                            <img src={devtty} alt="MT3 /DEV/TTY" className="absolute bottom-0 scale-110" />
                                        </div>
                                    ...
                                    <div className="flex flex-col items-center justify-start col-span-3 px-8 py-12 space-y-4 overflow-hidden sm:rounded-xl">
                                        <div className="w-full h-44 relative overflow-hidden shadow-xl">
                                            <img src={ember} alt="MG Ember" className="absolute -bottom-4 scale-125" />
                                        </div>
                    ...
                    <div className="mb-10">
                        ...
                        <div className="my-5 flex flex-wrap justify-center">
                            <img src={blanks} alt="Keyreative Blanks" />
                    ...
                    <div className="mb-10">
                        ...
                        <div className="container items-center max-w-7xl px-8 mx-auto xl:px-5 py-10">
                            <div className="flex flex-wrap items-stretch sm:-mx-3">
                                <div className="w-full md:w-1/2 md:px-5">
                                    <div>
                                        <img src={base} alt="GMK Botanical Base" />
                                    </div>
                                    <div>
                                ...
                                <div className="w-full md:w-1/2 md:px-5">
                                    <div>
                                        <img src={extension} alt="GMK Botanical Obscure" />
                                    </div>
                                    <div>
            ...
            <div className="container max-w-7xl px-8 mx-auto xl:px-5 text-right flex justify-between">
                    <div>
                        <Link to="/introduction/keyboard_layouts_and_sizes" className="inline-flex items-center w-full px-6 py-3 text-xl font-extrabold text-second bg-first md:px-3 md:w-auto rounded-xl lg:px-5 hover:bg-second hover:text-first focus:outline-none md:focus:ring-2 focus:ring-0 focus:ring-offset-2 focus:ring-second">⇦ Keyboard Layouts and Sizes</Link>
                    </div>
                    <div>
                        <Link to="/introduction/switches" className="inline-flex items-center w-full px-6 py-3 text-xl font-extrabold  text-second bg-first md:px-3 md:w-auto rounded-xl lg:px-5 hover:bg-second hover:text-first focus:outline-none md:focus:ring-2 focus:ring-0 focus:ring-offset-2 focus:ring-second">Switches ⇨</Link>
                    </div>
                </div>
            </section>
