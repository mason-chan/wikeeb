                ...
                <div className="container max-w-6xl mx-auto">
                    ...
                    <div className="grid grid-cols-3 gap-8 mt-10 sm:grid-cols-6 lg:grid-cols-9 sm:px-8 xl:px-0 text-center">
                        <div className="relative flex flex-col items-center justify-start col-span-3 px-8 py-12 space-y-4 overflow-hidden sm:rounded-xl">
                            <a href="/wikeeb/introduction/introduction_to_mechanical_keyboards" className="w-full h-44 relative overflow-hidden rounded-m shadow-xl sm:rounded-xl">
                            ...
                            <a href="/wikeeb/introduction/introduction_to_mechanical_keyboards" className="text-center text-first text-xl"><u>Read more ➜</u></a>
                        </div>
                        <div className="flex flex-col items-center justify-start col-span-3 px-8 py-12 space-y-4 overflow-hidden sm:rounded-xl">
                            <a href="/wikeeb/introduction/keyboard_layouts_and_sizes" className="w-full h-44 relative overflow-hidden rounded-md shadow-xl sm:rounded-xl">
                            ...
                            <a href="/wikeeb/introduction/keyboard_layouts_and_sizes" className="text-center text-first text-xl"><u>Read more ➜</u></a>
                        </div>
                        <div className="flex flex-col items-center justify-start col-span-3 px-8 py-12 space-y-4 overflow-hidden sm:rounded-xl">
                            <a href="/wikeeb/introduction/keycaps" className="w-full h-44 relative overflow-hidden rounded-md shadow-xl sm:rounded-xl">
                            ...
                            <a href="/wikeeb/introduction/keycaps" className="text-center text-first text-xl"><u>Read more ➜</u></a>
                        </div>
                        <div className="flex flex-col items-center justify-start col-span-3 px-8 py-12 space-y-4 overflow-hidden sm:rounded-xl">
                            <a href="/wikeeb/introduction/switches" className="w-full h-44 relative overflow-hidden rounded-md shadow-xl sm:rounded-xl">
                            ...
                            <a href="/wikeeb/introduction/switches" className="text-center text-first text-xl"><u>Read more ➜</u></a>
                        </div>
                        <div className="flex flex-col items-center justify-start col-span-3 px-8 py-12 space-y-4 overflow-hidden sm:rounded-xl">
                            <a href="/wikeeb/introduction/stabilizers" className="w-full h-44 relative overflow-hidden rounded-md shadow-xl sm:rounded-xl">
                            ...
                            <a href="/wikeeb/introduction/stabilizers" className="text-center text-first text-xl"><u>Read more ➜</u></a>
                        </div>
                        <div className="flex flex-col items-center justify-start col-span-3 px-8 py-12 space-y-4 overflow-hidden sm:rounded-xl">
                            <a href="/wikeeb/introduction/community" className="w-full h-44 relative overflow-hidden rounded-md shadow-xl sm:rounded-xl ">
                            ...
                            <a href="/wikeeb/introduction/community" className="text-center text-first text-xl"><u>Read more ➜</u></a>
                        </div>
                    </div>
                </div>
            </section>
